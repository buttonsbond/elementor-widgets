...
//	$this->add_box_shadow();
    ...
    $partner_id = $this->get_settings( 'partner_id' );
    $preferred_theme = $this->get_settings( 'preferred_theme' );
    $property_price = $this->get_settings( 'property_price' );
    $min_property_price = $this->get_settings( 'min_property_price' );
    $max_property_price = $this->get_settings( 'max_property_price' );
